...
func (pq *PermissionQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (pq *PermissionQuery) FirstIDX(ctx context.Context) uint32 {
...
func (pq *PermissionQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (pq *PermissionQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (pq *PermissionQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (pq *PermissionQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
