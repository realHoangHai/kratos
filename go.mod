module github.com/realHoangHai/kratos
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/logrus/v2 v2.0.0-20240627104009-3198e0b83bf2
	github.com/go-kratos/kratos/contrib/log/zap/v2 v2.0.0-20240627104009-3198e0b83bf2
	github.com/go-kratos/kratos/contrib/registry/zookeeper/v2 v2.0.0-20240627104009-3198e0b83bf2
